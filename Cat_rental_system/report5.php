...
require('connection.php'); 
  ...
  $sdate=$_POST['sdate'];
  $edate=$_POST['edate'];
  $query = "SELECT reserve_date, SUM(total_cost) AS total FROM reservation GROUP BY reserve_date HAVING (reserve_date BETWEEN '$sdate' AND '$edate')";
...
?>
    ...
    <thead>
            <tr>
                ...
                <?php echo "No payments found in this period";?>
                <?php else : ?>
